...
import 'add_place_direct_modal.dart';
...
class _AddPlaceModalState extends State<AddPlaceModal> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildOptionCard(
                      id: 'direct',
                      title: '직접 추가',
                      description: '장소·주소·알림·유형을 직접 입력해요',
                      icon: FontAwesomeIcons.pencil,
                      isSelected: _selectedOption == 'direct',
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) => const AddPlaceDirectModal(),
                          ),
                        );
                      },
                    ),
                    ...
                    _buildOptionCard(
                      id: 'url',
                      title: '지도 링크(url) 자동 변환',
                      description: '지도 링크만 붙여넣어도 자동 등록돼요',
                      icon: FontAwesomeIcons.link,
                      isSelected: _selectedOption == 'url',
                      onTap: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('지도 링크 자동 변환 기능은 추후에 제공됩니다'),
                    ...
                    _buildOptionCard(
                      ...
                      onTap: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('AI 장소 추천 기능은 추후에 제공됩니다'),
                            duration: Duration(seconds: 2),
                            behavior: SnackBarBehavior.floating,
                          ),
                        );
  ...
  Widget _buildOptionCard({
    ...
    final backgroundColor =
        isSelected ? AppTokens.bgTeal02 : AppTokens.bgBasic01;
    final borderColor =
        isSelected ? AppTokens.line06 : AppTokens.line03;
    final iconBackgroundColor =
        isSelected ? AppTokens.bgTeal04 : AppTokens.bgTeal03;
